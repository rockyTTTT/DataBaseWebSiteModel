<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <span slot="append">
        <el-dropdown class="search-dropdown" :trigger="dropdownTrigger">
          <el-button type="primary" class="input-button" @click="toggleDropdown">
          <i class="el-icon-arrow-down el-icon-arrow-down"></i>
        </el-button>
          <el-dropdown-menu slot="dropdown" class="input-dropdown-menu" v-if="dropdownVisible">
            <el-dropdown-item data-id = "Anal canal cancer" @command="handleDropdownCommand">Anal canal cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Bladder cancer" @command="handleDropdownCommand">Bladder cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Bile duct cancer" @command="handleDropdownCommand">Bile duct cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Breast cancer" @command="handleDropdownCommand">Breast cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Colon cancer" @command="handleDropdownCommand">Colon cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Gastric cancer" @command="handleDropdownCommand">Gastric cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Kidney cancer" @command="handleDropdownCommand">Kidney cancer</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </span>
      </el-input>
