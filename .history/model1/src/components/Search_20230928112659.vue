  ...
  methods: {
    ...
    handleCommand(command) {
      ...
      if (this.selected.length != 0) {
        ...
        let el = document.querySelector(".search-tag:last-child");
        let top = el.offsetTop - el.clientHeight;
        let left = el.offsetLeft + el.clientWidth;

        console.log('el top left',el,top,left);
        document.querySelector(
          ".builder-details  .el-textarea__inner"
        ).style.paddingLeft = left + 10 + "px";
        document.querySelector(
          ".builder-details  .el-textarea__inner"
        ).style.paddingTop = top + 10 + "px";
        document.querySelector(
          ".builder-details  .el-textarea__inner"
        ).style.height = el.offsetTop + 40 + "px";
      }
    },
