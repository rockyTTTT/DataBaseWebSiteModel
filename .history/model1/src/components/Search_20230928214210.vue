<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <!--Search builder -->
      <div class="builder-details" id="builder-details-Cancer" :style="{display:showCancer?'block':'none'}">
        ...
        <el-tooltip class="item" effect="dark" content="Remove this line from builder" placement="top-start">
        <el-button type="info" icon="el-icon-minus" circle class="delete_button" size="mini"></el-button>
        </el-tooltip>
      </div>
