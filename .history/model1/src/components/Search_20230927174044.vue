      ...
      <span slot="append">
        <el-dropdown class="search-dropdown" :trigger="dropdownTrigger">
          ...
          <el-dropdown-menu slot="dropdown" class="input-dropdown-menu">
            <el-dropdown-item data-id = "Anal canal cancer" @command="handleDropdownCommand" @click.native="preventDropdownHide">Anal canal cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Bladder cancer" @command="handleDropdownCommand" @click.native="preventDropdownHide">Bladder cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Bile duct cancer" @command="handleDropdownCommand" @click.native="preventDropdownHide">Bile duct cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Breast cancer" @command="handleDropdownCommand" @click.native="preventDropdownHide">Breast cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Colon cancer" @command="handleDropdownCommand" @click.native="preventDropdownHide">Colon cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Gastric cancer" @command="handleDropdownCommand" @click.native="preventDropdownHide">Gastric cancer</el-dropdown-item>
            <el-dropdown-item data-id = "Kidney cancer" @command="handleDropdownCommand" @click.native="preventDropdownHide">Kidney cancer</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </span>
      </el-input>
