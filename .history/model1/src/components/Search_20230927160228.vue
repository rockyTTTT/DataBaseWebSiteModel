    ...
    <el-card class="box-card">
      ...
      <div class="builder-details">
        ...
        <el-dropdown v-if="dropdownVisible" @command="handleDropdownCommand">
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>Anal canal cancer</el-dropdown-item>
            <el-dropdown-item>Bladder cancer</el-dropdown-item>
            <el-dropdown-item>Bile duct cancer</el-dropdown-item>
            <el-dropdown-item>Breast cancer</el-dropdown-item>
            <el-dropdown-item>Colon cancer</el-dropdown-item>
            <el-dropdown-item>Gastric cancer</el-dropdown-item>
            <el-dropdown-item>Kidney cancer</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
    </el-card>
